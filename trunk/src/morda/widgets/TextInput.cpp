...
Vec2r TextInput::ComputeMinDim(const morda::Vec2r& quotum)const NOEXCEPT{
	return Vec2r(this->SingleLineTextWidget::ComputeMinDim(Vec2r(-1)).x + D_CursorWidth, this->Font().BoundingBox().d.y - this->Font().BoundingBox().p.y);
}
