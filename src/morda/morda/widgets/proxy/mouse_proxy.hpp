...
public:
	 ...
	 */
	std::function<bool(widget& widget, bool is_down, const morda::vector2& pos, mouse_button button, unsigned pointer_id)> mouse_button_handler;
	 ...
	 */
	std::function<bool(widget& widget, const morda::vector2& pos, unsigned pointer_id)> mouse_move_handler;
	 ...
	 */
	std::function<void(widget& widget, unsigned pointer_id)> hover_changed_handler;
