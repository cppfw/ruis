...
renderer::renderer(std::unique_ptr<render_factory> factory, const renderer::params& params) :
		...
		pos_quad_01_vao(this->factory->create_vertex_array({this->quad_01_vbo}, this->quad_indices, VertexArray::Mode_e::TRIANGLE_FAN)),
		pos_tex_quad_01_vao(this->factory->create_vertex_array({this->quad_01_vbo, this->quad_01_vbo}, this->quad_indices, VertexArray::Mode_e::TRIANGLE_FAN)),
