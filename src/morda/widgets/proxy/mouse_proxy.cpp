...
bool mouse_proxy::on_mouse_button(bool isDown, const morda::Vec2r& pos, mouse_button button, unsigned pointerId){
...
bool mouse_proxy::on_mouse_move(const morda::Vec2r& pos, unsigned pointerId){
